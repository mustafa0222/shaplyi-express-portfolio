...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (whatsappForm) {
    whatsappForm.addEventListener('submit', (e) => {
      ...
      const message = `Name: ${name}%0APhone: ${phone}%0AAddress: ${address}`;
  ...
  const translations = {
    en: {
      ...
      form: { name: 'Your Full Name', phone: 'Your Phone Number', address: 'Your Address', submit: 'Send Message' },
    ...
    ar: {
      ...
      form: { name: 'الاسم الكامل', phone: 'رقم الهاتف', address: 'العنوان', submit: 'إرسال الرسالة' },
    ...
    ku: {
      ...
      form: { name: 'ناوی تەواو', phone: 'ژمارەی تەلەفۆن', address: 'ناونیشان', submit: 'ناردنی نامە' },
